...
geom_boxplot(na.rm = TRUE) + labs(title = "Income Vs Frailty Vs Clavien-Dindo Grade 4 Complications in All UHS Colectomy Patients") +
...
geom_boxplot() + labs(title = "Income Vs Frailty Vs Hispanic Ethnicity in All UHS Colectomy Patients with No CD4 Complications") +
...
geom_boxplot() + labs(title = "Income Vs Frailty Vs Hispanic Ethnicity in All UHS Colectomy Patients with CD4 Complications") +
scale_fill_discrete(name = "Ethnicity"
                    ,breaks = c("No", "Unknown", "Yes")
                    ,labels = c("Non-Hispanic", "Unknown", "Hispanic")
                    )-> plot_cd4;
...
ggplot(data = thedata, aes(x = factor(a_discrete_rai)
                           ,y = income_final,fill=a_any_cd4)) + 
  geom_violin(na.rm = TRUE) + labs(title = "Income Vs Frailty Vs Clavien-Dindo Grade 4 Complications in All UHS Colectomy Patients") +
  scale_fill_discrete(name = "Clavien-Dindo Grade4"
                      ,breaks = c("FALSE", "TRUE")
                      ,labels = c("No", "Yes")
  ) -> plot_any_cd4_violin;
...
ggplot(data = thedata2, aes(x = a_discrete_rai
                            ,y = income_final, fill = hispanic_ethnicity)) + 
  geom_violin() + labs(title = "Income Vs Frailty Vs Hispanic Ethnicity in All UHS Colectomy Patients with No CD4 Complications") +
  scale_fill_discrete(name = "Ethnicity"
                      ,breaks = c("No", "Unknown", "Yes")
                      ,labels = c("Non-Hispanic", "Unknown", "Hispanic")
  )-> plot_no_cd4_violin;
...
thedata3 <- dat1subs[["all_colon_all"]] %>% select(a_discrete_rai,hispanic_ethnicity, income_final, a_any_cd4) %>% group_by( a_discrete_rai,hispanic_ethnicity) %>% 
  filter(a_any_cd4=='TRUE')
ggplot(data = thedata3, aes(x = a_discrete_rai, y = income_final,fill=hispanic_ethnicity)) + 
  geom_violin() + labs(title = "Income Vs Frailty Vs Hispanic Ethnicity in All UHS Colectomy Patients with CD4 Complications") +
  scale_fill_discrete(name = "Ethnicity"
                      ,breaks = c("No", "Unknown", "Yes")
                      ,labels = c("Non-Hispanic", "Unknown", "Hispanic")
  )-> plot_cd4_violin;
